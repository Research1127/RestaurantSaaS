...
## 🍽️ Create Dish Endpoint (Nested Resource)
...
- Automatically copies properties with the same name, like  
  `Name`, `Description`, `Price`, `KiloCalories`, `RestaurantId`.

- Simplifies handler code so you don’t manually assign each property.
